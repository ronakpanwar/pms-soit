          ...
          <div className="card shadow-lg border-0">
            <div className="card-body p-5">
              ...
              <p className="card-text fs-8 text-secondary">
                Welcome to the <strong>Placement Portal</strong> of [Your College Name]. Our platform is exclusively for students of [Your College Name], providing a central hub for placement opportunities. It helps students stay updated with company openings, apply for on-campus job positions, and access important resources such as resume-building tools, interview tips, and career counseling.
              </p>
              <p className="card-text fs-8 text-secondary">
              ...
              <p className="fs-8 text-secondary">
                Our platform is designed specifically for students of [Your College Name]. Students can view the latest job openings from top companies, apply directly through the portal, and track their application status. With dedicated sections for both students and companies, this portal ensures a seamless recruitment process.
              </p>
              <div className="text-center mt-4">
                <a href="/more-info" className="btn btn-primary px-4 py-2">Learn More</a>
              </div>
            </div>
          </div>
        </div>
